...
namespace SeatClientV3
{
    ...
    public partial class MainWindow : Window
    {
        ...
        bool IsWork = false;
        int count = int.Parse(System.Configuration.ConfigurationManager.AppSettings["ReadCardCount"].ToString());
        ...
        private void timeLoop_TimeTo(object sender, EventArgs e)
        {
            ...
            if (count == 0) //如果15秒结束
            {
                ...
                count = int.Parse(System.Configuration.ConfigurationManager.AppSettings["ReadCardCount"].ToString());//重新初始化倒计时的数值
                StopRead();//停止读卡
                //更换按钮上的文字开始
                this.btnGetNo_Copy.Dispatcher.Invoke(
                new Action(
