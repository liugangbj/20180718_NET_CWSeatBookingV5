...
namespace SeatManageWebQUI.Controllers.FunctionPages.Code
{
    public class SeatLayoutTools
    {
        ...
        /// <returns></returns>
        public string drowBespeakSeatLayOutHtml(string roomNum, string strDate, string divTransparentTop,string divTransparentLeft)
        {
            DateTime date;
            try
            {
        ...
        /// <param name="divTransparentLeft"></param>
        /// <returns></returns>
        public string DrawNowBespeakSeatLayoutHTML(string roomNum, string divTransparentTop, string divTransparentLeft)
        {
            if (string.IsNullOrEmpty(roomNum))
            {
                return "阅览室编号不能为空";
